...
\begin{abstract}
The first paragraph of the first abstract in each document is used as short description.

The second paragraph will not be included but they can be read in the full document.
\end{abstract}
